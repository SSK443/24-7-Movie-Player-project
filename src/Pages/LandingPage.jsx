...
function LandingPage() {
  ...
  return (
    <>
      <div
        className="land w-full h-fit pb-20"
      ...
      >
        <div className="flex justify-between items-center flex-col md:flex-row w-[80%] mx-auto h-fit pb-10">
          <div className="left h-fit md:w-[500px] text-left mt-10 w-[350px]">
            <h1 className="text-5xl text-white mt-5">
              Welcome to Movie 24/7 App
            </h1>
            <p className="text-white mt-4 text-justify">
              Movie 24/7 allows you to add and remove uploaded videos. It also
              helps to arrange them in different categories with drag-and-drop
              functionality.
            </p>
            <button
              className="px-4 py-2 rounded-lg mb-5 text-white mt-4 bg-teal-500 hover:bg-teal-600 transition duration-300 animate-bounce"
          ...
          <div className="right h-fit md:w-[500px] w-[350px] md:mt-0 mt-5">
            <img
              src="./one.gif"
              alt="Welcome"
              className="md:w-full md:my-10 md:h-[600px]"
            />
          </div>
        </div>
        ...
        <div
          className="videos flex justify-between items-center flex-wrap text-white w-[80%] h-fit mx-auto md:gap-5 md:mt-10 mt-3 gap-10 md:p-5 p-8"

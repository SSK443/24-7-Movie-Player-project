    ...
    <>
      <div className="w-full min-h-[80vh] bg-gray-900">
        ...
        <div className="flex flex-col md:flex-row w-[90%] h-fit justify-between mx-auto text-white p-5 items-center">
          ...
          <Link
            to="/Watch"
            className="text-2xl hover:text-teal-500 transition duration-300 mt-4 md:mt-0"
          >
            WatchHistory
          </Link>
        </div>
...
Home.propTypes = {
  setUploadVideoResponse: PropTypes.func,
  setRemoveCategoryVideoResponse: PropTypes.func,
  uploadVideoResponse: PropTypes.array,
  removeCategoryVideoResponse: PropTypes.string,
};

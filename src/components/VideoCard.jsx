...
//removing video
 ...
 const dragStarted=(e,vId)=>{
  ...
  return (
    <>
      <div className="bg-gray-800 shadow-lg rounded-lg overflow-hidden transform transition-transform duration-500 hover:scale-105 hover:shadow-xl cursor-pointer" draggable onDragStart={(e)=>dragStarted(e,displayData?.id)}>
        <img
        ...
        <div className="p-4 flex justify-between items-center text-white">
          ...
          {!insideCategory &&  <button className="text-red-600 hover:text-red-800" onClick={() => deleteVideo(displayData ?.id)}>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75 z-50">
          <div className="bg-gray-800 text-white p-6 rounded-lg w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 animate-fadeIn">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold">{displayData?.videoCaption}</h2>
            ...
            <button onClick={handleClose} className="bg-blue-600 px-4 py-2 rounded text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300">
              Close
            </button>
          </div>
        </div>
